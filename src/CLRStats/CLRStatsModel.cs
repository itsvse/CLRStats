...
namespace CLRStats
{
    ...
    {
        private readonly static ServerRequest serverRequest = new ServerRequest();
        private readonly static ApplicationRequest  applicationRequest = new ApplicationRequest();
    ...
    {
        private readonly static CPUStatsRequest cPUStatsRequest = new CPUStatsRequest();
        private readonly static GCStatsRequest gCStatsRequest = new GCStatsRequest();
